...
1. [AAP 对接指南](../aap-integration-guide.zh-CN.md)：认证、scope、Conversation、Run、SSE、错误、CORS、密钥轮换和上线检查（含可选 [A2UI §9.2](../aap-integration-guide.zh-CN.md#92-a2ui可选附加)、[出站附件 §9.3](../aap-integration-guide.zh-CN.md#93-出站附件可选附加) 与[入站按需读取 §9.4](../aap-integration-guide.zh-CN.md#94-入站按需读取可选附加)）。
...
7. 可选入站 PDF 读取见[对接指南 §9.4](../aap-integration-guide.zh-CN.md#94-入站按需读取可选附加)（`actweave.read_attachment`；持久化 part 仍是 `input_file`）。
