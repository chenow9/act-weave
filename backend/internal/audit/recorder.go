...
const (
	...
	ActionAgentPromptPreviewed          = "agent.prompt.previewed"
	ActionAgentPromptPreviewPromoted    = "agent.prompt.preview_promoted"
	ActionAgentPromptPreviewPurged      = "agent.prompt.preview_purged"
	ActionAgentPromptPreviewPurgeFailed = "agent.prompt.preview_purge_failed"
)
