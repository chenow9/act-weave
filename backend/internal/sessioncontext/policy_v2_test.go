...
func TestParsePolicyV2AgentAAP(t *testing.T) {
	...
	if err != nil || doc2.IncludeCompactionSummary() || doc2.EnableA2UI() || doc2.EnableOutboundAttachments() {
	...
	if err != nil || doc3.IncludeCompactionSummary() || doc3.EnableA2UI() || doc3.EnableOutboundAttachments() {
		t.Fatalf("empty aap false: %+v err=%v", doc3, err)
	}
	if doc3.AAP == nil || doc3.AAP.IncludeCompactionSummary == nil || doc3.AAP.EnableA2UI == nil ||
		doc3.AAP.EnableOutboundAttachments == nil {
...
func TestParsePolicyV2EnableA2UINullNormalizesFalse(t *testing.T) {
	raw := json.RawMessage(`{
		"schemaVersion":"session-context-policy.v2",
		"aap":{"enableA2UI":null,"includeCompactionSummary":null,"enableOutboundAttachments":null}
	}`)
